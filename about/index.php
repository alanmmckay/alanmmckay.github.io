...
produce_front_matter("About");
?>
                    <header>
                        <h1>Welcome to alanmckay.blog</h1>
                    </header>
                    <p>
                    ...
                    <!--p>
                        A lot can be gleaned of a person by taking a critical look at the content they produce. As mentioned in the section prior, reading what I've produced on this site allows one to more closely know my motives and attitudes as an individual. I encourage a read of one of my pages to learn more about me beyond
                    </p-->
                </article>
                <nav>
                    <a href='../'>Back</a>
