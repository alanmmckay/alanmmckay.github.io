            ...
            <section>
                <article>
                   ...
                   <p>
                    ...
                    <iframe frameborder="0" style='width:100%;height:190px;overflow:auto' src='code/01.html'>
                    </iframe>
                    <p>
                    ...
                    <!--- JAVASCRIPT EXAMPLE! --->
                    <iframe frameborder="0" style='width:100%;height:340px;overflow:auto' src='code/02.html'>
                    </iframe>
                    <p>
                        The logic described above is called upon by some event handler that detects when the window is scrolled.
                    </p>
                    <!--- JAVASCRIPT EXAMPLE! --->
                    <iframe frameborder="0" style='width:100%;height:140px;overflow:auto' src='code/03.html'>
                    </iframe>
                    <p>
