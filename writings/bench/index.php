...
$meta['title'] = 'Alan McKay | The Bench';
...
?>
        <section id='writingsWrapper'>
            <header id='breadNav' class='writingNav' style='overflow:hidden;'>
                <h1 class='breadCurrent'><a href='./' class='currentLink'>&nbsp;&gt; The Bench</a>
            ...
            <section>
                <article>
                    ...
                    <p>
                        I circled around towards the bench. Still empty. <br>
                    ...
                    <p>
                        Thankfully, Clayton strolled into view.<br>
                    ...
                    <p>
                        It was just like the old times. With this gathering, the heaviness of the campus started to lift.<br>
                    ...
                    <hr>
                    <p>
                        The following morning I stepped onto campus again. <br>
                        Alone. <br>
                        I once again walked the paths. <br>
                        I once again stepped through the buildings in which a lot of time was spent. <br>
                        Time of a different context. <br>
                    </p>
                    <p>
                    ...
                    <p style='text-align:left'>
                        -I hope this is not the last time that we enjoyed this tradition Clayton, Aaron, Shane, Reagan, Ben, and any others who joined us. If it is, I'm glad to have had the experience and hope the same for you as well!<br>
                        -Alan
                    </p>
                </article>
                <nav>
