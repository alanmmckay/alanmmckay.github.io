...
$meta['title'] = 'Alan McKay | Connectivity of Sound';
...
?>
        <section id='writingsWrapper'>
            <header id='breadNav' class='writingNav' style='overflow:hidden;'>
                <h1 class='breadCurrent'><a href='./'>&nbsp;&gt; The Connectivity of Sound</a>
            ...
            <section>
                <article>
                    ...
                    <p>
                        Silence is interupted, "Hello Alan."<br>
                        I hesitate, then focus to see a man with a guitar on his back and portable amp in hand.<br>
                        "Hello Sean," I respond. <br>
                        He follows up, "You get a second show."
                    </p>
                    <p>
                        Sean asks the barkeep if he can play in the store. Of course, Connor says yes. <br>
                    ...
                    <p>
                        The porcelain mug makes contact with the countertop. And the warm music begins to fill the air again.<br>
                    ...
                    <p style='text-align:left'>
                        -I appreciate the connection we've made Sean.<br>
                        -Alan
                    </p>
                </article>
                <nav>
