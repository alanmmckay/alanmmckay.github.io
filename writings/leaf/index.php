...
?>
        <section id='writingsWrapper'>
            <header id='breadNav' class='writingNav' style='overflow:hidden;'>
                <h1 class='breadCurrent'><a href='./' class='currentLink'>&nbsp;&gt; Leaves</a>
            ...
            <section>
                <article>
                    ...
                    <p>
                        Nothing prepares the world for winter as well as a drifting leaf.<br>
                        Beginning a bud, it is immediately a symbol of coming warmth and life.<br>
                        Sprouting from a tree, the leaf becomes one one of many among a bastion of green.<br>
                        There, the collective selflessly provides for the tree while others seek refuge from the filtered sun rays.<br>
                        Acting as one of many, a humble leaf diligently sustains life while making life comfortable for others.<br>
                    </p>
                    <p>
