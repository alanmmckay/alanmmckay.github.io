...
$meta['title'] = 'Alan McKay | Social Media';
...
?>
        <section id='writingsWrapper'>
            <header id='breadNav' class='writingNav' style='overflow:hidden;'>
                <h1 class='breadCurrent'><a href='./' class='currentLink'>&nbsp;&gt; Social Media</a>
            ...
            <section>
                <article>
                    ...
                    <p style='text-align:left'>
                        I prefer not to maintain an Instagram account anymore. This is contrary to a vsco account, where an occasional picture is posted. Feel free to take a look at my social media presence here: <a href='https://vsco.co/alanmckay' target="_blank" rel="noopener noreferrer">https://vsco.co/alanmckay</a>
                    </p>
                </article>
                <nav>
                    <a href='../'>Back</a>
