        ...
        <section id='writingsWrapper'>
            ...
            <section>
                <article>
                    ...
                    <blockquote>
                        Within an ERB template, Ruby code can be included using both &lt;% %&gt; and &lt;%= %&gt; tags. The &lt;% %&gt; tags are used to execute Ruby code that does not return anything, such as conditions, loops, or blocks, and the &lt;%= %&gt; tags are used when you want output. <cite> - <a href='https://guides.rubyonrails.org/action_view_overview.html' target="_blank" rel="noopener noreferrer">Action View Overview - Rails Guides</a>
                    </blockquote>
